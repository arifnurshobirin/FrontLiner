        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a href="#hero" class="site-logo"><img src="portfolio/img/logo.png" alt="logo"></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <img src="portfolio/img/arif.jpg" alt="Arif">
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        ...
                        <p>Hello! I'm Arif, a  web developer, Seorang yang punya mimpi,bekerja dengan sepenuh hati, percaya akan usaha tidak akan menghianati hasil, seorang soldier , dan cinta keluarga</p>
                        <a href="portfolio/img/cv.pdf" class="btn btn-fill" target="_blank" download>Download my cv</a>
                    </div>
                </div>
            </div>
        ...
        <section id="service" class="site-section section-services overlay text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="service">
                            <img src="portfolio/img/front-end.svg" alt="Front End Developer">
                            <h4>Front-end</h4>
                    ...
                    <div class="col-sm-4">
                        <div class="service">
                            <img src="portfolio/img/back-end.svg" alt="Back End Developer">
                            <h4>Back-end</h4>
                    ...
                    <div class="col-sm-4">
                        <div class="service">
                            <img src="portfolio/img/consultancy.svg" alt="Coding">
                            <h4>Consultancy</h4>
