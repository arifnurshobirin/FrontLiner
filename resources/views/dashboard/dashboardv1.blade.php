@extends('layouts.app') 
@section('title tab','DashboardV1 Page')
@section('title page','DashboardV1 Page')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="urlpage">DashboardV1 Page</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('admin') }}">Home</a></li>
                    <li class="breadcrumb-item active urlpage">DashboardV1 Page</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
