@extends('layouts.app') 
@section('title tab','Mail Box Page')
@section('title page','Mail Box Page')
...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="urlpage">Mail Box Page</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ url('admin') }}">Home</a></li>
                    <li class="breadcrumb-item active urlpage">Mail Box Page</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <table class="table table-hover table-striped">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="mailbox-name"><a href="read-mail.html">Arif Nur Shobirin</a></td>
                                    <td class="mailbox-subject"><b>FrontLiner 1.0 Issue</b> - Trying to find a solution to
                                        this problem...
                                    </td>
